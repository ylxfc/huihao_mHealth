...
<script language="javascript">
  function check()
  {
    seridlen=window.document.form3.serId.value.length;
    serpassword=window.document.form3.serPassword.value.length;
    sername=window.document.form3.serName.value.length;
    sersexlen=window.document.form3.serSex.value.length;
    seragelen=window.document.form3.serAge.value.length;
    serphonelen=window.document.form3.serPhone.value.length;
    medidlen=window.document.form3.medId.value.length;
    havsignedagencylen=window.document.form3.havSignedAgency.value.length;
    havvisitedlen=window.document.form3.havVisited.value.length;
    serid=window.document.form3.serId.value;
    sersex=window.document.form3.serSex.value;
    serage=window.document.form3.serAge.value;
    serphone=window.document.form3.serPhone.value;
    medid=window.document.form3.medId.value;
    havsignedagency=window.document.form3.havSignedAgency.value;
    havvisited=window.document.form3.havVisited.value;
	...
	<tr>
	  <td>
		    ...
		    <table width="90%" border="0" cellspacing="0" cellpadding="0"  align="center">
              <tr>
                <td>
                <form name="form3" method="post" action="updateUser.do" >
                  <p>&nbsp;</p>
